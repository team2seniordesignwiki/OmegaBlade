...
Inputs: void
Return: This function should return true if omega mode is active or false if it is
		not.
Purpose: This function is responsible for checking the inter-blade connection inputs
		 ...
		 way. The function should simply output true if omega mode is active and
		 false if it is not.
Developer: Derrian Glynn
------------------------------------------------------------------------------------*/
